  ...
  return (
    <main className="flex flex-col items-center justify-between min-h-screen p-24">
      <div className="z-10 items-center justify-between w-full max-w-5xl font-mono text-sm lg:flex">
        <p className="fixed top-0 left-0 flex justify-center w-full px-4 pt-8 pb-6 border-b bg-gradient-to-b backdrop-blur-2xl border-neutral-800 bg-zinc-800/30 from-inherit lg:static lg:w-auto lg:rounded-xl lg:border lg:bg-zinc-200 lg:p-4 lg:bg-zinc-800/30">
      ...
      <div className="relative flex place-items-center ">
        ...
        <div className="flex flex-col items-center justify-center gap-8 mt-16 lg:mt-24">
          {LINKS.map((link) => (
            <a
              className="flex flex-col items-center justify-center gap-2 p-8 text-center bg-gradient-to-b from-accent to-accent/90 rounded-xl shadow-lg backdrop-blur-2xl"
              href={link.href}
              key={link.href}
              rel="noopener noreferrer"
              target="_blank"
