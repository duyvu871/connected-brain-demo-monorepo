...
function UploadPopover() {
	...
	return (
		<div className="flex flex-col justify-center items-center gap-4 relative p-4">
			<div
				className={cn(
					'relative bg-zinc-200 max-h-72 overflow-hidden rounded-xl flex justify-center items-center cursor-pointer',
					isShowImage ? '' : 'hidden',
				)}
				onClick={() => {
				}}>
			...
			<div className="flex flex-col items-center justify-center w-full">
				<div className="flex items-center justify-center w-full">
					<label className="flex flex-col items-center justify-center w-full h-24 border-2 border-zinc-300 border-dashed rounded-lg cursor-pointer bg-zinc-50 dark:hover:bg-bray-800 dark:bg-zinc-700 hover:bg-zinc-100 dark:border-zinc-600 dark:hover:border-zinc-500 dark:hover:bg-zinc-600"
