...
export default function MainApp(): JSX.Element {
	return (
		<Box className="h-full w-full flex flex-col-reverse items-center sm:flex-row gap-5 justify-center sm:items-start p-5">
			<div className="flex-grow flex items-start max-w-[400px] w-full sm:w-fit sm:max-w-full h-fit">
					<ExtractResult />
			</div>
