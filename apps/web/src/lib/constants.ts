import type { SpeakingState } from "@/interfaces";
...
export const DEFAULT_FROM_QUERY_LANGUAGE = "vi";
...
export const languages: Language[] = [
  { value: "Vietnamese", label: "Vietnamese", lang: "vi-VN", query: "vi" },
...
export const languageByLang: Record<string, Language> = languages.reduce(
  (acc, language) => ({
    ...acc,
