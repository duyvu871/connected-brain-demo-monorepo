...
const BlobBackground = forwardRef<SVGSVGElement, React.SVGProps<SVGSVGElement>>((props, ref) => {
	...
	return (
		<svg ref={ref} viewBox="0 0 200 200" xmlns="http://www.w3.org/2000/svg" {...props}>
			...
			<g filter="url(#bbblurry-filter)">
				...
				>
					<path
						className="top fill-zinc-400/80 dark:fill-zinc-800/20"
					...
					/>
					<path
						className="middle fill-zinc-300/80 dark:fill-zinc-700/20"
					...
					/>
					<path
						className="bottom fill-zinc-200/80 dark:fill-zinc-600/20"
